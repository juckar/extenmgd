...
class Columna :
    ...
    def QTalineacion( self, alin ) :
        """
        Convierte un parámetro de alineación para que sea usable por PySide
        """
        if alin == "c" :
    ...
    def QTcolorTexto( self, rgb ) :
        """
        Convierte un parámetro de color del texto para que sea usable por PySide
        """
        if rgb == -1 :
    ...
    def QTcolorFondo( self, rgb ) :
        """
        Convierte un parámetro de color del fondo para que sea usable por PySide
        """
        if rgb == -1 :
            return QtCore.QVariant()
        else :
